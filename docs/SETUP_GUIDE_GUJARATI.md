...
### કેવી રીતે વાપરવું — OBS જેવું, ખેંચીને ગોઠવો

1. **Overlays** → **+ New overlay**
2. ઉપરના બટનથી element ઉમેરો: **+ Text · + Ticker · + Clock · + Logo · + Bar**
3. **સીધું screen પર ખેંચીને** જ્યાં જોઈએ ત્યાં મૂકો
4. **ખૂણાના ચોરસ ખેંચીને** size બદલો (logo મોટો/નાનો, લખાણ મોટું/નાનું)
5. જગ્યા નક્કી થઈ જાય તો **🔒 lock** કરી દો — પછી ભૂલથી ખસશે નહીં
6. **Create overlay** → પછી નીચે તમારી stream key સામે **Apply**

**મદદરૂપ વાતો:**
- Stream ચાલુ હોય તો canvas માં **તમારો જ live video પાછળ દેખાશે** — એટલે ખબર પડે કે logo ચહેરા પર તો નથી આવતો
- ખેંચતી વખતે કિનારે/વચ્ચે **આપોઆપ ચોંટે** (snap). ન જોઈએ તો **Shift** દબાવી રાખો
- **Arrow keys** થી બારીક ખસેડો (Shift + arrow = મોટા પગલાં)
- **⇔ centre / ⇕ middle / ↔ full width** બટન એક ક્લિકમાં ગોઠવી દે
- બધું **ટકાવારીમાં** સચવાય છે — 1080p થી 720p કરો તો layout આપોઆપ બંધ બેસે
